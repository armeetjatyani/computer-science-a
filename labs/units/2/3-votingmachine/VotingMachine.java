...
public class VotingMachine {
    ...
    public double percentDemocrat() {
        return ((double) democratVotes) / totalVotes();
    }
    ...
    public double percentRepublican() {
        return ((double) republicanVotes) / totalVotes();
    }

    /**
     * calculate the perecnt of votes for the independent party
     * @return double - percent of the votes that are for the independent party
     */
    public double percentIndependent() {
        return ((double) independentVotes) / totalVotes();
    }

    /**
     * Gives all vote statistics
     * @return String - vote statistics, vote counts, percentages, and total votes
     */
    public String toString() {
        return "Democrats: " + democratVotes + "\nRepublicans: " + republicanVotes + "\nIndependents: "
